...
//
// The 'username' used by the sync service is potentially munged to make it
// fit into URLs without including invalid characters (like email addresses
// do, so now that sync forces email address names this is pretty essential)
...
function username_munge($username) {
